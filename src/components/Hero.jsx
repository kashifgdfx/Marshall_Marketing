          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
            ...
            <motion.div whileHover={{ y: -3, scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm px-8 py-4 text-sm font-bold uppercase tracking-[0.12em] text-white transition-colors duration-300 hover:bg-white/20 hover:border-white"
              >
                Our Services
                <motion.span
                  animate={{ x: [0, 6, 0] }}
